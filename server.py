...
<button class="share-trigger detail-share" type="button" data-share-trigger data-share-url="{item['detailUrl']}" data-share-name="{name}" aria-label="Compartilhar {name}" aria-haspopup="menu" aria-expanded="false"><svg viewBox="0 0 24 24" aria-hidden="true"><circle cx="18" cy="5" r="3"/><circle cx="6" cy="12" r="3"/><circle cx="18" cy="19" r="3"/><path d="m8.6 10.5 6.8-4M8.6 13.5l6.8 4"/></svg>Compartilhar</button>
